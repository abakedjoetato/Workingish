...
class AnalyticsCog(commands.Cog):
    ...
    async def server_analytics(
        ...
        try:
            ...
            await ctx.respond(embed=error_embed(
                "Error", 
                f"An error occurred while fetching server analytics: {e}"))
    ...
    async def player_analytics(
        ...
        try:
            ...
            await ctx.respond(embed=error_embed(
                "Error",
                f"An error occurred while fetching player analytics: {e}"))
                
    @analytics.command(
        name="player_by_id", 
        description="Get player analytics using exact Steam ID", 
        contexts=[discord.InteractionContextType.guild],
        integration_types=[discord.IntegrationType.guild_install]
    )
    @server_exists()
    ...
    @analytics.command(
        name="faction", 
        description="Get detailed faction analytics", 
        contexts=[discord.InteractionContextType.guild],
        integration_types=[discord.IntegrationType.guild_install]
    )
    @server_exists()
