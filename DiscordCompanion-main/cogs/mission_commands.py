...
class MissionCommands(commands.Cog):
    ...
    async def initialize_mission_trackers(self):
        ...
        try:
            ...
            cursor = await collection.find({}) # Get all configs, we'll filter in Python
    ...
    async def list_missions(self, ctx, *, server_name: str = None, event_type: str = None, limit: int = 10):
        ...
        try:
            ...
            if server_name:
                ...
                # Get recent events
                collection = await db.get_collection("server_events")
            ...
            while True:
                try:
                    ...
                    for event_data in new_events:
                        ...
                        server = await Server.get_by_id(db, event.server_id)
